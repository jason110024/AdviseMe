		...
		try{
			...
			if(!reCaptchaReponse.isValid()){
				...
				String htmlBody = "<!doctype html>"
						...
						+ "                                               <a href=\"#\"><img src=\"http://advisemeut.appspot.com/assets/img/logo1-default.png\"></a>"
						+ "                                           </td>"
						+ "                                       </tr>"
						+ "                                   </table><!--End logo-->"
						+ "                               </td>"
						...
						+ "                                                   </tr>"
						+ "                                                    <tr>"
						+ "                                                        <td  class=\"center\" style=\"font-size: 12px; color: #ffffff; font-weight: bold; text-align: left; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px ; \" >"
						...
						+ "                                                    <tr>"
						+ "                                                        <td valign=\"top\" style=\"padding: 10px 20px 0px \" class=\"center\">"
						+ "                                                             <a href=\"http://advisemeut.appspot.com/home.jsp\">"
						+ "      <div class=\"col-md-4\">"
						+ "            <div class=\"service\">"
						+ "                   <i class=\"icon-home service-icon\"></i>"
						+ "              <div class=\"desc\">"
						+ "                 <h4>Go Back to Home Page</h4>"
						+ "                       <p>Visit AdviseMe Now!</p>"
						+ "              </div>"
						+ "          </div>"
						+ "       </div>"
						+ "        </a>"
						...
						+ "                                                        <a href=\"http://jasona-ee461l-webappblog.appspot.com/\">Blog</a>"
						+ "                                                     </td>"
						+ "                                                      <td valign=\"top\" style=\"padding: 10px 15px 0px\" class=\"center\">"
						+ "                                                           <a href=\"https://twitter.com/AdviseMeUT\">Twitter</a>"
						+ "                                                        </td>"
						+ "                                    <td valign=\"top\" style=\"padding: 10px 15px 0px\" class=\"center\">"
						+ "                                         <a href=\"https://www.youtube.com/channel/UCTE-dQdEBZQpOIphPIec_Og\">YouTube</a>"
						+ "                                      </td>"
						+ "                                   </tr>"
						+ "                                </table>"
						+ "                             </td>"
