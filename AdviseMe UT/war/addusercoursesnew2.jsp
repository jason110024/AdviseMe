			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 md-margin-bottom-40">
						...
						<p class="margin-bottom-25 md-margin-bottom-40">Helping
							students help students in order to help students by helping!</p>
						<!-- End About -->
					...
					<div class="col-md-4 md-margin-bottom-40">
						...
						<div class="posts">
							...
							<dl class="dl-horizontal">
								<dt>
									<a href="#"><img
										src="assets/img/sliders/elastislide/10.jpg" alt="" /></a>
								</dt>
								<dd>
									<p>
										<a href="#">Anim moon officia Unify is an incredibly
					...
					<div class="col-md-4">
						...
						<address class="md-margin-bottom-40">
							Somewhere, Street <br /> Texas, US <br /> Phone: 000 123 3456 <br />
							Fax: 000 123 3456 <br /> Email: <a
