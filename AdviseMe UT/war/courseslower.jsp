	...
	<div class="wrapper">
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown"><a class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									...
									<li><a href="javascript:void(0);">Lower Division</a></li>
		...
		<div class="container s-results margin-bottom-50">
			<div class="row">
				...
				%>
				<div class="col-md-10">
					<span class="results-number">${fn:escapeXml(num_lower)}
						results</span>
					<%
						if (schools.isEmpty()) {
							...
							<dd>
								<p>
									<a href="http://jasona-ee461l-webappblog.appspot.com/">Check
										out our development blog to keep track of new developments and
										features available on AdviseMe!</a>
								</p>
							</dd>
						</dl>
